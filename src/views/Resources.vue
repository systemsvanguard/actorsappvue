...
<template>
    <!-- Resources ~ Page -->
    <img src='/images/site/resources_1.webp' alt="Resources" class="img-fluid w-100" />

    <div class="container py-2">
        <h1 class='my-1 text-primary'>Resources</h1>
        ...
        <p>Deadlights jack lad schooner scallywag dance the hempen jig carouser broadside cable strike colors. Bring a
            ...
            doubloon chase. Belay yo-ho-ho keelhaul squiffy black spot yardarm spyglass sheet transom heave to. Case
            shot Shiver me timbers gangplank crack Jennys tea cup ballast Blimey lee snow crow's nest rutters. Fluke jib
    ...
    <img src='/images/site/resources_2.webp' alt="Resources" class="img-fluid w-100" />
    <br />
