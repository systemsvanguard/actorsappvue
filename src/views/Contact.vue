...
<template>
    <!-- Contact Us ~ Page -->
    <img src='/images/site/contact_1.webp' alt="Contact Us" class="img-fluid w-100" />

    <div class="container py-2">
        <h1 class='my-1 text-primary'>Contact Us</h1>
    ...
    <br />
    <img src='/images/site/contact_2.webp' alt="Contact Us" class="img-fluid w-100" />
    <br />
